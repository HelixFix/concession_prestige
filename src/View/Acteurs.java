...
import Controller.ControllerActeurs;
...
public class Acteurs {
    ...
    private final ControllerActeurs controllerActeurs;
    ...
    public Acteurs(Group root, ViewHandler vh) {

        this.root = root;
        this.controllerActeurs = new ControllerActeurs(this, vh);
    ...
    private void initButtons() {
        ...
        retour.setOnMouseClicked(controllerActeurs);
    ...
    private void initChamp(){
        ...
        t2 = new TextField("Acteur : Prenom");
