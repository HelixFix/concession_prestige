...
import Controller.ControllerNationalite;
...
public class Nationalité {

    private final Group root;
    private final ControllerNationalite controllerNationalite;
    ...
    public Nationalité(Group root, ViewHandler vh) {

        this.root = root;
        this.controllerNationalite = new ControllerNationalite(this, vh);
    ...
    private void initButtons() {
        ...
        retour.setOnMouseClicked(controllerNationalite);
